@include('header') @include('blocks/navigation') 
@include('blocks/page-title', { "page-title" : "Our Courses", "page-link": "courses.html", "single-page-title": "Photography", "nasted": "nasted", "description" : "Our courses offer a good compromise
