@include('header.htm') @include('blocks/navigation.htm', {"home": "active"}) @include('blocks/slider.htm') @include('blocks/banner-feature.htm') @include('blocks/about.htm')
...
@include('blocks/cta.htm') @include('blocks/success-story.htm')
