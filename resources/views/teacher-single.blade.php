@include('header.htm') @include('blocks/navigation.htm') @include('blocks/page-title.htm', { "page-title" : "Our Teacher", "page-link": "teacher.html", "single-page-title": "John Doe", "nasted": "nasted", "description" : "Our courses offer a good compromise
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                ...
                <p class="mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis
                    ...
                    omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto.</p>
            </div>
        </div>
