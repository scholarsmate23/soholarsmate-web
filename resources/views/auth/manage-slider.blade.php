...
<div class="table-title">
    <div class="row">
        ...
        <div class="col-sm-6">
            <a href="#addSliderImageModal" class="btn btn-success" data-toggle="modal"><i class="ti-plus menu-icon"></i> <span>Add Image</span></a>
...
<table class="table table-striped table-hover">
    ...
    @foreach($data as $item)
        <tr>
            <td>
                <img src="{{ asset('storage/slider/'.$item['file_name'])}}" alt="{{ $item['file_name'] }}" style="max-width: 100px; max-height: 100px;">
            </td>
            ...
            <td>
                <a href="#deleteSliderImageModal" class="delete" id="deleteImage" data-toggle="modal" value="{{ $item->id }}"><i class="ti-trash menu-icon"></i></a>
            </td>
        </tr>
        @endforeach
...
<div class="modal fade" id="addSliderImageModal" tabindex="-1" role="dialog" aria-labelledby="addImageModalLabel" aria-hidden="true">
...
<!-- Delete Image Modal -->
<div class="modal fade" id="deleteSliderImageModal" tabindex="-1" role="dialog" aria-labelledby="deleteImageModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" id="delete_slider_image_id" name="id">
            </div>
